...
class Employee(db.Model):
    ...
    reviews = db.relationship('Review', back_populates = 'employee', cascade='all, delete_orphan')

    onboarding = db.relationship('Onboarding', uselist = False, back_populates='employee', cascade='all, delete_orphan')
